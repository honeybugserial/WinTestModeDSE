...
install()  # enable rich tracebacks
...
def main():
    ...
    console.print(
        " _ _ _  _         ___             _      __ __         _         ___  ___  ___    ___            _  \n"
        "| | | |[_] _ _   |_ _| ___  ___ _| |_   |  \\  \\ ___  _| | ___   | . \\/ __]| __]  |_ _| ___  ___ | | \n"
        "| | | || || ' |   | | / ._][_-[  | |    |     |/ . \\/ . |/ ._]  | | |\\__ \\| _]    | | / . \\/ . \\| | \n"
        "|__/_/ |_||_|_|   |_| \\___./__/  |_|    |_|_|_|\\___/\\___|\\__-.  |___/[___/|___]   |_| \\___/\\___/|_| "
    )
